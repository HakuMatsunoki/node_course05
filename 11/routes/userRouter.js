...
router.patch('/update-me', userMiddleware.uploadUserAvatar, userController.updateMe);
router.patch('/update-my-password', userMiddleware.checkMyPassword, userController.updateMyPassword);
