const { checkUserExistsById, checkUserExists, checkUserPasswords } = require('../services/userService');
...
exports.checkMyPassword = catchAsync(async (req, res, next) => {
  ...
  // validate new password with regexp

  await checkUserPasswords(req.user.id, currentPassword, newPassword);
